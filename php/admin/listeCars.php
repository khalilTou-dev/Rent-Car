...
<body>
    ...
    <?php include("../Car.php"); ?>
                <?php
                $car = new Car();
                // appeler la fonction list pour selectionner les donnees du table participant
                $res = $car->list();
                ?>
    <div class="col-lg-9">
    <a class="btn btn-success"  style="margin-top: 150px;margin-left:150px" href="ajoutCar.html">Ajouter une vehicule</a>
        ...
        ?>
            <tbody>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');" href="deletecar.php?matricule=<?php echo $ligne[0]; ?>">Supprimer</a>
                        <a class="btn btn-success" href="./modifCar.php?matricule=<?php echo $ligne[0]; ?>&marque=<?php echo $ligne[1] ?>&type=<?php echo $ligne[2] ?>&prix=<?php echo $ligne[3] ?>&image=<?php echo $ligne[4] ?>"> Modifier</a>
                    </td>
                </tr>
            <?php
        }
